...
class ProfessionalModel(UserModel):
    ...
    subspecialties = db.relationship('SubspecialtyModel', secondary=subspecilaty_professional, back_populates='professionals')
    accepted_health_plans = db.relationship('HealthPlanModel', secondary=health_plan_professional, back_populates='professionals')
